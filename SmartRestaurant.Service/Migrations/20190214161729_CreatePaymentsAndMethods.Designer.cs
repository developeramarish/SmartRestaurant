...
namespace SmartRestaurant.Service.Migrations
{
    ...
    [Migration("20190214161729_CreatePaymentsAndMethods")]
    partial class CreatePaymentsAndMethods
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartRestaurant.Service.Models.Payment", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SmartRestaurant.Service.Models.PaymentMethod", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SmartRestaurant.Service.Models.Payment", b =>
                {
                    ...
                    b.HasOne("SmartRestaurant.Service.Models.PaymentMethod", "PaymentMethod")
                        .WithMany()
